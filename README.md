...
![React](https://img.shields.io/badge/React-19-blue) ![Vite](https://img.shields.io/badge/Vite-Fast-yellow) ![Tailwind](https://img.shields.io/badge/Style-Tailwind-cyan) ![AI Status](https://img.shields.io/badge/AI-80%25%20Claude%20Pro-purple) ![Licencia](https://img.shields.io/badge/Licencia-GRATIS-green)
...
1.  **Configuración:** Elegí la cantidad de jugadores (3 a 15), cuántos impostores querés y seleccioná las categorías.
2.  **Roles:** Pasen el celular. Cada jugador toca la carta para ver su rol.
    * **Ciudadanos:** Ven la **Palabra Secreta** (Ej: "Milanesa").
    * **Impostor:** Solo ve "IMPOSTOR". No sabe la palabra.
3.  **Debate:** Empieza el jugador marcado. Hacen preguntas por turnos sobre la palabra secreta.
...
4.  **Votación:** Cuando el **Temporizador** suena, señalen al sospechoso.
...
1.  **Clonar el repositorio:**
    ```bash
    git clone [https://github.com/tu-usuario/impostor-argentina.git](https://github.com/tu-usuario/impostor-argentina.git)
...
¡Este proyecto se actualiza constantemente!
¿Tenés ideas para nuevas palabras o modos de juego?
